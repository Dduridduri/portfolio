...
function App() {
  ...
  <div className="w-[1920px] h-[126px]">
    <svg
      ...
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      className="absolute left-[-0.5px] top-[124.5px]"
      preserveAspectRatio="none"
    >
      <line x1="0.000260417" y1="0.5" x2={1920} y2="1.5" stroke="black" />
    </svg>
    <svg
      width={1}
      height={125}
      ...
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      className="absolute left-[318.5px] top-[-0.5px]"
      preserveAspectRatio="none"
    >
      <line x1="0.5" x2="0.5" y2={125} stroke="black" />
    </svg>
    <p className="absolute left-[820px] top-[43px] text-2xl text-left text-[#111]">About</p>
    <p className="absolute left-[1073px] top-[43px] text-2xl text-left text-[#111]">Works</p>
    <p className="absolute left-[952px] top-[43px] text-2xl text-left text-[#111]">Skills</p>
    <p className="absolute left-[1207px] top-[43px] text-2xl text-left text-[#111]">Contact</p>
    <p className="absolute left-[86px] top-[43px] text-[32px] font-bold text-left">
      <span className="text-[32px] font-bold text-left text-white">K.</span>
